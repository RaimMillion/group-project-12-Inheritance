...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        TestBase backend2 = new BackendConfig();
        TestBase ui2 = new UIConfig();

        System.out.println(base.equals(base1));
        System.out.println(backend.equals(backend2));
        System.out.println(ui.equals(ui2));
